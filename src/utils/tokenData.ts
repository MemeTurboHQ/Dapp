  ...
  return [
    {
      ...
      symbol: 'BONK',
      decimals: 5,
      image_uri: 'https://raw.githubusercontent.com/solana-labs/token-list/main/assets/mainnet/DezXAZ8z7PnrnRJjz3wXBoRgixCa6xjnB7YaB1pPB263/logo.png',
      price: 0.000015,
      priceChange24h: 12.5,
      volume24h: 45000000,
    ...
    },
    {
      ...
      symbol: 'WIF',
      decimals: 6,
      image_uri: 'https://raw.githubusercontent.com/solana-labs/token-list/main/assets/mainnet/EKpQGSJtjMFqKZ9KQanSqYXRcF8fBopzLHYxdM65zcjm/logo.png',
      price: 2.45,
      priceChange24h: -5.2,
      volume24h: 85000000,
    ...
    },
    {
      ...
      symbol: 'PEPE',
      decimals: 6,
      image_uri: 'https://assets.coingecko.com/coins/images/29850/large/pepe-token.jpeg',
      price: 0.000008,
      priceChange24h: 18.7,
      volume24h: 32000000,
      marketCap: 890000000,
    ...
    },
    {
      ...
      symbol: 'USDT',
      decimals: 6,
      image_uri: 'https://raw.githubusercontent.com/solana-labs/token-list/main/assets/mainnet/Es9vMFrzaCERmJfrF4H2FYD4KCoNkY11McCe8BenwNYB/logo.png',
      price: 1.0,
      priceChange24h: -0.02,
      volume24h: 380000000,
    ...
    },
    {
      ...
      symbol: 'ETH',
      decimals: 8,
      image_uri: 'https://raw.githubusercontent.com/solana-labs/token-list/main/assets/mainnet/7vfCXTUXx5WJV5JADk17DUJ4ksgau7utNKj4b963voxs/logo.png',
      price: 3245.12,
      priceChange24h: 4.2,
      volume24h: 95000000,
    ...
    },
    {
      ...
      symbol: 'BTC',
      decimals: 8,
      image_uri: 'https://raw.githubusercontent.com/solana-labs/token-list/main/assets/mainnet/3NZ9JMVBmGAqocybic2c7LQCJScmgsAZ6vQqTDzcqmJh/logo.png',
      price: 68450.0,
      priceChange24h: 1.8,
      volume24h: 185000000,
    ...
    },
    {
      ...
      symbol: 'SBR',
      decimals: 6,
      image_uri: 'https://raw.githubusercontent.com/solana-labs/token-list/main/assets/mainnet/Saber2gLauYim4Mvftnrasomsv6NvAuncvMEZwcLpD1/logo.png',
      price: 0.012,
      priceChange24h: -8.5,
      volume24h: 3500000,
      marketCap: 45000000,
    ...
    },
    {
      ...
      symbol: 'ORCA',
      decimals: 6,
      image_uri: 'https://raw.githubusercontent.com/solana-labs/token-list/main/assets/mainnet/orcaEKTdK7LKz57vaAYr9QeNsVEPfiu6QeMU1kektZE/logo.png',
      price: 0.85,
      priceChange24h: 6.3,
      volume24h: 12000000,
      marketCap: 125000000,
    ...
    },
    {
      ...
      symbol: 'RLB',
      decimals: 2,
      image_uri: 'https://assets.coingecko.com/coins/images/30171/large/RLB.png',
      price: 0.045,
      priceChange24h: -12.3,
      volume24h: 8500000,
      marketCap: 285000000,
